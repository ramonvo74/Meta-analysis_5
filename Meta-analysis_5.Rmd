...
knitr::include_graphics("https://media.giphy.com/media/FHzemFzwkyRfq/giphy.gif") # From giphy
```
...
Two **extra terms in the equation**: $\epsilon_k$ and $\zeta_k$.  Thin of these as 2 types of **independent errors** which cause our regression prediction to be **imperfect**. 
...
```{r, out.width = "400px", echo=FALSE, fig.align='center', fig.cap= 'https://xkcd.com/1478/'}
knitr::include_graphics("p_values_2x.png") # From xkcd.com
```
...
```{r, out.width = "500px", echo=FALSE, fig.align='center',fig.cap='illustration of interaction from Harrer'}
knitr::include_graphics("Interaction_illustration.png") # From harrer (2019)
```
...
knitr::include_graphics("https://media.giphy.com/media/3o7btRT1IUGb8YjPlS/giphy.gif") # From giphy.com 
```
...
```{r, out.width = "550px", echo=FALSE, fig.align='center', fig.cap="Illustration from Harrer"}
knitr::include_graphics("overfitting.png") # https://bookdown.org/MathiasHarrer/Doing_Meta_Analysis_in_R/multiple-meta-regression.html
```
...
```{r, warning=FALSE, message=FALSE, dev='svg', out.width = "325px", fig.align='center'}
require(ggcorrplot)
...
knitr::include_graphics("https://media.giphy.com/media/x4QKAmG3mjqQo/giphy.gif")
```
...
```{r, out.width = "350px", echo=FALSE, fig.align='center'}
knitr::include_graphics("https://media.giphy.com/media/NSn97BHtWn3Tq/giphy.gif")
```
...
```{r, out.width = "500px", echo=FALSE, fig.align='center'}
knitr::include_graphics("https://media.giphy.com/media/Pk20jMIe44bHa/giphy.gif") # from giphy.com
```
